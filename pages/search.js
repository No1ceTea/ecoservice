...
export default function Search(props) {
  ...
  const addToCartHandler = async (product) => {
    ...
    if (data.countInStock < quantity) {
      toast.error('Désolé, le produit est victime de son succès');
      return;
    }
        ...
        <div className="md:col-span-3">
          <div className="mb-2 flex items-center justify-between border-b-2 pb-2">
            <div className="flex items-center">
              {products.length === 0 ? 'No' : countProducts} Résultat(s)
            ...
            <div>
              ...
              <select value={sort} onChange={sortHandler}>
                ...
                <option value="lowest">Prix: Ordre croissant</option>
                <option value="highest">Prix: Ordre décroissant</option>
                <option value="toprated">Moyenne des évaluations client</option>
